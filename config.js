...
module.exports = {
    ...
    SESSION: process.env.ALEXA_SESSION === undefined ? '' : process.env.ASENA_SESSION,
    OWNER: process.env.OWNER_NAME === undefined ? 'KAVISHKA SANDARUWAN' : process.env.OWNER_NAME,
    OWNERNUM: process.env.OWNER_NUMBER === undefined ? '94769370896' : process.env.OWNER_NUMBER,
    ...
    CP: process.env.CAPTION === undefined ? 'Lusifar' : process.env.CAPTION,
    HANDLERS: process.env.HANDLERS === undefined ? '^[#.!]' : process.env.HANDLERS,
    SEND_READ: process.env.SEND_READ === undefined ? false : convertToBool(process.env.SEND_READ),
    BRANCH: 'master',
    DEVELOPER: 'KAVISHKA-SANDARUWAN',
    AUTHOR: 'KAVISHKA SANDARUWAN',
    GIT: 'https://github.com/lkruwan/WhatsAlexa.git',
    HEROKU: {
